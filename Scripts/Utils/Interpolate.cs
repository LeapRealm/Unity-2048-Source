...
public delegate float EaseFunc(float start, float distance, float elapsedTime, float duration);
...
public class Interpolate
{
     ...
     */
    public static float Ease(EaseFunc ease,
     ...
     */
    public static Vector2 Ease(EaseFunc ease,
     ...
     * on all three vector axis.
     */
    public static Vector3 Ease(EaseFunc ease,
     ...
     * on all axis.
     */
    public static Quaternion Ease(EaseFunc ease,
     ...
     */
    public static EaseFunc Ease(EaseType type)
    {
